...
: "${MINIO_RESTORE_ACCESS_KEY:?set MINIO_RESTORE_ACCESS_KEY to a restore-capable MinIO credential}"
: "${MINIO_RESTORE_SECRET_KEY:?set MINIO_RESTORE_SECRET_KEY to a restore-capable MinIO credential}"
