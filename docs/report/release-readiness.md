...
따라서 `38807bd` 기준 저장소 내부 release candidate는 backend·frontend·parity·기능 E2E gate를 통과했고 working tree도 깨끗하다. 남은 저장소 외부 또는 CI 의존 항목은 GitHub Actions의 보안 scan 결과와 실제 VPS/SMTP/media/backup 환경 검증이며, 이를 local 성공으로 대체하지 않는다.
