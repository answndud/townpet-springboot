...
- 근거: `MemberDirectory`, `PublicationService`, `PublicationFeed`, V007, `PublicationControllerTest`, `feed-parity.spec.ts`, `ModularityTest`, `LayerRulesTest`, `api/openapi/townpet.yaml`, `OpenApiContractTest`
