...
- 변경:
  ...
  - block·제재·ownership 결과가 profile과 저장 콘텐츠에서 일관되게 보이게 한다. 비회원·상호 차단 대상은 public profile을 열람할 수 없게 한다.
...
- 완료: 기능이 같은 것뿐 아니라 주요 page family의 시각·반응형·접근성·직접 URL 동작이 Legacy와 비교 가능한 수준이다.
