...
- 성능: Feed query-plan 수치는 합성 fixture baseline이며 운영 SLA가 아니다. 별도로 VPS에서 15분·최대 40 VU public-read ramp를 실행했지만, 이것도 SLA나 최대 처리량으로 해석하지 않는다. release 판단은 VPS smoke/live E2E와 CI gate를 기준으로 한다.
