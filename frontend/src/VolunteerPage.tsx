...
export default function VolunteerPage() {
  ...
  async function create(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      await volunteerApi.create({ ...form, startsAt: new Date(form.startsAt).toISOString(), capacity: Number(form.capacity), ...(animalCommunityCodes.length ? { animalCommunityCodes } : {}) });
