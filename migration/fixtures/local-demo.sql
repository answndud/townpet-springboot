...
INSERT INTO publication (id, author_member_id, type, animal_interest_code, title, body, lifecycle, created_at, updated_at, version)
VALUES
  ('00000000-0000-4000-8000-000000003101', '00000000-0000-4000-8000-000000000201', 'FREE_BOARD', 'DOG', '망원 산책 초보자를 위한 저녁 코스', '해 질 무렵 걷기 좋은 구간과 물을 챙길 때의 팁을 정리했습니다. 처음 함께 걷는 분들도 편하게 의견을 남겨 주세요.', 'ACTIVE', '2026-08-10T10:00:00+09:00', '2026-08-10T10:00:00+09:00', 0),
  ('00000000-0000-4000-8000-000000003102', '00000000-0000-4000-8000-000000000202', 'FREE_BOARD', NULL, '반려동물과 이사할 때 먼저 확인한 것들', '이동장, 동물병원 기록, 새 동네 산책로를 준비한 순서를 공유합니다. 다른 보호자님의 체크리스트도 궁금해요.', 'ACTIVE', '2026-08-09T09:30:00+09:00', '2026-08-09T09:30:00+09:00', 0);
...
-- Keep the community index explicit so the new animal-first routes have
-- deterministic coverage for every structured board.
DELETE FROM content_animal_community
WHERE (content_kind, content_id) IN (
  ('PUBLICATION', '00000000-0000-4000-8000-000000003101'),
  ('PUBLICATION', '00000000-0000-4000-8000-000000003102'),
  ('MARKETPLACE', '00000000-0000-4000-8000-000000007101'),
  ('MARKETPLACE', '00000000-0000-4000-8000-000000007102'),
  ('LOST_FOUND', '00000000-0000-4000-8000-000000009101'),
  ('LOST_FOUND', '00000000-0000-4000-8000-000000009102'),
  ('ADOPTION', '00000000-0000-4000-8000-00000000e201'),
  ('ADOPTION', '00000000-0000-4000-8000-00000000e202'),
  ('GATHERING', '00000000-0000-4000-8000-00000000d201'),
  ('GATHERING', '00000000-0000-4000-8000-00000000d202'),
  ('VOLUNTEER', '00000000-0000-4000-8000-00000000f201'),
  ('VOLUNTEER', '00000000-0000-4000-8000-00000000f202'),
  ('HOSPITAL_REVIEW', '00000000-0000-4000-8000-00000000f101'),
  ('HOSPITAL_REVIEW', '00000000-0000-4000-8000-00000000f102'),
  ('CARE_REQUEST', '00000000-0000-4000-8000-00000000f401'),
  ('CARE_REQUEST', '00000000-0000-4000-8000-00000000f402')
);

INSERT INTO content_animal_community (content_kind, content_id, animal_code)
VALUES
  ('PUBLICATION', '00000000-0000-4000-8000-000000003101', 'DOG'),
  ('PUBLICATION', '00000000-0000-4000-8000-000000003102', 'CAT'),
  ('MARKETPLACE', '00000000-0000-4000-8000-000000007101', 'DOG'),
  ('MARKETPLACE', '00000000-0000-4000-8000-000000007102', 'DOG'),
  ('LOST_FOUND', '00000000-0000-4000-8000-000000009101', 'DOG'),
  ('LOST_FOUND', '00000000-0000-4000-8000-000000009102', 'CAT'),
  ('ADOPTION', '00000000-0000-4000-8000-00000000e201', 'DOG'),
  ('ADOPTION', '00000000-0000-4000-8000-00000000e202', 'CAT'),
  ('GATHERING', '00000000-0000-4000-8000-00000000d201', 'DOG'),
  ('GATHERING', '00000000-0000-4000-8000-00000000d202', 'CAT'),
  ('VOLUNTEER', '00000000-0000-4000-8000-00000000f201', 'DOG'),
  ('VOLUNTEER', '00000000-0000-4000-8000-00000000f202', 'CAT'),
  ('HOSPITAL_REVIEW', '00000000-0000-4000-8000-00000000f101', 'DOG'),
  ('HOSPITAL_REVIEW', '00000000-0000-4000-8000-00000000f102', 'CAT'),
  ('CARE_REQUEST', '00000000-0000-4000-8000-00000000f401', 'CAT'),
  ('CARE_REQUEST', '00000000-0000-4000-8000-00000000f402', 'DOG')
